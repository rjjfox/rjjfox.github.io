...
I'd thought I was too cool to read the books everyone was talking about. But when my teacher read the Philosopher's Stone to my class one term, I very quickly became Pottermad. This started a near-constant cycle of re-reading the Harry Potter series that still continues in some form til today. Nowadays, I only ever read, rather than listen, the books as the first adult book I attempt to read learning a new language. I mostly listen to the Harry Potter books, they help me to switch off and sleep.
...
Nowadays I read all sorts and easily read one or two books a week. In the last year I've actually read over 100 books, a new record for me. Here are my tips to read more.
